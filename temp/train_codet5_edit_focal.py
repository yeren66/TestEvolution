...
import logging
from codet5_edit_focal import Code2Code
from codet5_edit_focal import Config
from utils import readjson, loadpkl
import pickle
...
from codet5_edit_focal import GenDataset, read_examples
import torch
...
if cofig.do_test:
    ...
    for idx,file in enumerate(files):   
        ...
        ppp = []
        idx = 0
        with open(os.path.join(cofig.output_dir,"test_epoch{0}.output".format(i)),'w') as f, open(os.path.join(cofig.output_dir,"test_epoch{0}.gold".format(i)),'w') as f1:
